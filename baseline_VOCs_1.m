...
for y = 1:length(years);
    for m = 1:length(months);
        ...
        month = months{m};
       % 定义物种列表
       species_list_for_SAPRC = {'ACET', 'CCHO', 'ALK1', 'ALK2', 'ALK3', 'ALK4', 'ALK5',...
                                 'HCHO', 'MEK',  'OLE1', 'OLE2', 'ARO1', 'ARO2', 'ETHE',...    
                                 'RCHO', 'MEOH', 'MACR' };
       species_list_for_GC = { 'ACET', 'CCHO',  'ALK1', 'ALK2', 'ALK3', 'ALK4', 'ALK5',...
                               'HCHO', 'MEK',   'OLE1',  'OLE2', 'TOLU', 'XYLE', 'ETHE',...
                               'RCHO',  'MOH',  'MACR'  }; 
       numC =  {'2', '3', '2', '2', '3', '4', '4', '4',...
         '1', '4', '5', '5', '5', '7', '8', '2',...
         '1', '4', '3', '1', '4'};
       ...
       for i = 1:length(species_list_for_SAPRC)
           current_species = species_list_for_SAPRC{i};
             path{i}.agriculture= fullfile(base_path, year, [year '_' month '_agriculture_SAPRC99_' current_species '.nc']);
             path{i}.industry= fullfile(base_path, year, [year '_' month '_industry_SAPRC99_' current_species '.nc']);
             path{i}.power= fullfile(base_path, year, [year '_' month '_power_SAPRC99_' current_species '.nc']);
             path{i}.residential= fullfile(base_path, year, [year '_' month '_residential_SAPRC99_' current_species '.nc']);
             path{i}.transportation= fullfile(base_path, year, [year '_' month '_transportation_SAPRC99_' current_species '.nc']);
       end
       % 输出路径
